<?php
	...
	$emailOB = $user->getUserAttribute('email');
	$fnOB = $user->getUserAttribute('fn');
	$lnOB = $user->getUserAttribute('ln');
	$cityOB = $user->getUserAttribute('city');
	...
	//$bdOB = $bd->format('m/d/Y'); // Format date from database into more common format to display in form

	$pnumOB = $user->getUserAttribute('pnum');
